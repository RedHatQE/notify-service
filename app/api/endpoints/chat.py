...
async def send_message(
    ...
    template_name: str = Query(
        ...
        "Check sample at https://github.com/RedHatQE/notify-service/tree/main/app/templates/build",
    ),
    environment: Union[
    ...
    webhook_url: Optional[AnyHttpUrl] = Query(
        None, description="The gchat or slack webhook url"
    ),
    ...
    if not template_url and (
        ...
        or (
            ...
            and isinstance(environment.body, dict)
